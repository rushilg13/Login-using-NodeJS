...
mongoose.connect('mongodb://localhost:27017/Test_Daphnis', {useNewUrlParser:true, useUnifiedTopology:true})
...
const login = async (emailId) => {
  const res = await Auth(emailId, "Daphnis Labs Technologies Pvt. Ltd. Demo");
...
app.use(session({secret: 'Daphnis Labs Technologies Pvt. Ltd. Demo', saveUninitialized: true, resave: false}));
